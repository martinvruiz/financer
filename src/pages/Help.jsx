export const Help = () => {
  return (
    <>
      <div className="flex flex-col text-center text-white w-4/5 mb-4 items-center">
        <h2 className="text-xl lg:text-3xl font-semibold my-2 p-2">
          Preguntas frecuentes
        </h2>
        <h4 className="w-3/4 p-2 text-center text-lg">Algunas son:</h4>
        ...
        <p>Abajo del formulario, el boton azul "Guardar".</p>
        <p className="p-2 my-2 font-medium">
          ¿Como se que no se perderan mis datos?
        </p>
        <p>
          Se guardan en los datos del navegador, es unico para cada usuario. Son
          intransferibles.
        </p>
        <p className="p-2 my-2 font-medium">¿Hay un limite para guardar?</p>
        <p>
          No, no hay un limite. Cada usuario puede guardar la cantidad de datos
          que necesite.
        </p>
        <p className="p-2 my-2 font-medium">
        ...
        <p>
          Si, en cada gasto o ingreso aparece el boton de eliminar, este paso es
          irreversible.
        </p>
        <p className="p-2 my-2 font-medium">
